          ...
          <div className="notice-list">
            ...
            <div className="notice-item">
              ...
              <div className="notice-content">
                ...
                <br />
                这里考虑到实际情况，设定了在每一条路径中，“允许连续多次对精零1级干员进行升级”最多出现10次，“允许连续多次对精一1级干员进行升级”最多出现5次，“允许连续多次对精二1级干员进行升级”最多出现3次。
                <br />
                3. 龙门币消耗与经验计算公式：
                <br />
                ...
                1
                次，但同一条路径中可以出现多次该步骤。目的是提醒使用者，针对以上等级，每个干员最好只使用一个作战记录，避免产生不当的跨级现象。
                <br />
                5.图片直观说明：
                <br />
