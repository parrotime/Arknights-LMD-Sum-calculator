          ...
          <section className={styles['rule-grid']} aria-label="规则说明">
            ...
            <article className={styles['rule-card']}>
              ...
              <div className={styles['rule-body']}>
                ...
                <p>
                  而不要为了图方便，对同一位干员连续投喂两轮6个基础作战记录（一共12个），这会导致误差发生。
                </p>
              </div>
            </article>
            ...
            <article className={styles['rule-card']}>
              ...
              <div className={styles['rule-body']}>
                <p>
                  这个设置的目的是排除升级“不是等级为1级”的干员，因此当这个按钮开启时，请确保其他三个升级开关中，至少有一个为开启状态。
                </p>
              </div>
            </article>
            ...
            <article className={styles['rule-card']}>
              ...
              <div className={styles['rule-body']}>
                ...
                <p>
                  解释：从某一级升级到下一级所需的全部经验乘以龙门币消耗系数 X，即为该级升级到下一级所需的龙门币。
                </p>
                <p>
                ...
                <p>
                  游戏中，根据这个公式，每次升级计算出消耗的龙门币数量其实带有小数（例如计算得到 114.514 ），但呈现给玩家的实际界面只显示且消耗整数部分龙门币（实际消耗 114 龙门币）。
                </p>
                <p>
                  简单来说，就是会出现“使用 1 次作战记录消耗 20 龙门币，而连续使用 2 次作战记录消耗 41 龙门币”的情况。
                </p>
                <p>
                  因此在查看计算得到的方案中，对于通过“使用作战记录”消耗龙门币的步骤，
                  请跟随步骤提示依次进行操作，防止出现上述小数点原因导致的误差。
                </p>
